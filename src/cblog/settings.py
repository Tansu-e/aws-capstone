...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/esra/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/esra/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstone.cvceeeq4k7jq.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'awscapstones-tansu-blog' # please enter your s3 bucket name
